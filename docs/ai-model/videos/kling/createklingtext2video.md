...
```bash
curl -X POST "https://你的newapi服务器地址/kling/v1/videos/text2video" \
...
`openapi/generated/ai-model/视频（Videos）/可灵格式/post-kling-v1-videos-text2video-createklingtext2video-383844639.json`

...
| --- | --- |
| 方法 | `GET` |
| 路径 | `/kling/v1/videos/image2video/{task_id}` |
...
```bash
curl -X GET "https://你的newapi服务器地址/kling/v1/videos/image2video/task_123456" \
...
`openapi/generated/ai-model/视频（Videos）/可灵格式/get-kling-v1-videos-image2video-task-id-getklingimage2video-383844642.json`

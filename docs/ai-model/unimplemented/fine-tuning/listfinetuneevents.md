...
```bash
curl -X GET "https://你的newapi服务器地址/v1/fine-tunes/string/events" \
...
`openapi/generated/ai-model/未实现（Unimplemented）/微调（Fine-tuning）/get-v1-fine-tunes-fine-tune-id-events-listfinetuneevents-383826500.json`

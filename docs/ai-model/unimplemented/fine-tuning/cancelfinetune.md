...
```bash
curl -X POST "https://你的newapi服务器地址/v1/fine-tunes/string/cancel" \
...
`openapi/generated/ai-model/未实现（Unimplemented）/微调（Fine-tuning）/post-v1-fine-tunes-fine-tune-id-cancel-cancelfinetune-383826499.json`
